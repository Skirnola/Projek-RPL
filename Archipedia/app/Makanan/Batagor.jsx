...
const RecipeScreen = () => {
  ...
  const ingredients = [
    { name: "Kacang Tanah", quantity: "100g", icon: "🥜" },
    { name: "Air", quantity: "1 liter + 500 ml", icon: "💧" },
    { name: "Bawang Putih", quantity: "6 siung", icon: "🧄" }, // 3 + 3
    { name: "Bawang Merah", quantity: "5 siung", icon: "🧅" },
    { name: "Kemiri", quantity: "5 biji", icon: "🌰" },
    { name: "Cabe Merah Keriting", quantity: "10 buah", icon: "🌶️" },
    { name: "Cabe Rawit", quantity: "6 buah", icon: "🌶️" },
    { name: "Gula Merah", quantity: "60g", icon: "🍬" },
    { name: "Air Asam Jawa", quantity: "1 sdt", icon: "🍋" },
    { name: "Garam", quantity: "2 sdt", icon: "🧂" }, // 1 + 1
    { name: "Kaldu Bubuk", quantity: "1 + 1/2 sdt", icon: "✨" },
    { name: "Gula Pasir", quantity: "1/2 sdt", icon: "🍚" },
    { name: "Tapioka", quantity: "250g", icon: "🌾" },
    { name: "Tepung Terigu", quantity: "125g", icon: "🌾" },
    { name: "Daun Bawang", quantity: "secukupnya", icon: "🌿" },
    { name: "Tahu", quantity: "2 buah", icon: "🍢" },
    { name: "Telur", quantity: "1 butir", icon: "🥚" },
    { name: "Lada", quantity: "1/2 sdt", icon: "⚫" },
    { name: "Baking Soda", quantity: "1/2 sdt", icon: "🥄" },
  ];
