...
const RecipeScreen = () => {
  ...
  const ingredients = [
    { name: "Beras", quantity: "450g", icon: "🍚" },
    { name: "Daun Salam", quantity: "3 lembar", icon: "🌿" },
    { name: "Serai", quantity: "1 batang", icon: "🌾" },
    { name: "Garam", quantity: "secukupnya", icon: "🧂" },
    { name: "Santan", quantity: "600 ml", icon: "🥥" },

    { name: "Santan Kental", quantity: "250 ml", icon: "🥥" },
    { name: "Daun Salam", quantity: "2 lembar", icon: "🌿" },
    { name: "Lengkuas", quantity: "2 iris", icon: "🪵" },
    { name: "Garam", quantity: "secukupnya", icon: "🧂" },
  ];

  const steps = [
    "Cuci bersih beras lalu masukkan ke dalam panci.",
    "Tambahkan santan, daun salam, serai, dan garam.",
    "Masak dengan api sedang sambil sesekali diaduk hingga santan terserap dan nasi setengah matang.",
    "Kukus nasi hingga matang dan pulen.",
    "Untuk areh: masak santan kental bersama daun salam, lengkuas, dan garam dengan api kecil sambil diaduk hingga mengental.",
    "Sajikan nasi liwet bersama areh di atasnya sebagai pelengkap.",
  ];
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollContent}>
        ...
        <View style={styles.titleContainer}>
          <Text style={styles.title}>Nasi Liwet Solo</Text>
          <Text style={styles.reviews}>(8K Reviews)</Text>
        </View>
